...
### ৩.৫ অ্যাক্টিভ/ইন-অ্যাক্টিভ টগল স্ট্যান্ডার্ড (STRICT Active/Inactive Toggle Standard)
- **নো রেডিও/চেকবক্স ফর স্ট্যাটাস:** মাস্টার ডাটার কোনো ফর্মে অ্যাক্টিভ/ইন-অ্যাক্টিভ বা অপারেশনাল স্ট্যাটাস নির্ধারণের জন্য সাধারণ রেডিও বাটন (`<input type="radio">`) বা অপরিকল্পিত চেকবক্স ব্যবহার করা সম্পূর্ণ নিষিদ্ধ।
- **বাধ্যতামূলক টগল প্রিমিটিভ:** সর্বত্র স্ট্যান্ডার্ড রিইউজেবল `<Toggle>` কম্পোনেন্ট (`components/common/Toggle.tsx`) এবং সেন্ট্রালাইজড টোকেন `UI_TOKENS.toggle.*` ব্যবহার করতে হবে।
- **স্পষ্ট মাইক্রোকপি:** টগলের পাশে পরিষ্কারভাবে কারেন্ট স্ট্যাটাস ("Active" বা "Inactive") এবং সহায়ক মাইক্রোকপি প্রদর্শিত হতে হবে।
