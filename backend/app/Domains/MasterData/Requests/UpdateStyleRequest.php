...
class UpdateStyleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'base_smv'         => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:999.99'],
            'wash_type'        => ['sometimes', 'nullable', 'string', 'max:500'],
            'description'        => ['nullable', 'string', 'max:1000'],
            'techpack_file_url'  => ['sometimes', 'nullable', 'string', 'max:500'],
            'techpack_file_name' => ['sometimes', 'nullable', 'string', 'max:255'],
            'techpack_file_size' => ['sometimes', 'nullable', 'integer', 'min:0'],
            'techpack_file'      => ['nullable', 'file', 'mimes:pdf,zip,rar,doc,docx,xls,xlsx,png,jpg,jpeg', 'max:25600'],
