...
class StoreCompanyRequest extends FormRequest
{
     ...
     * Company Code is STRICTLY system-generated by the backend — it is NEVER accepted from client input.
     *
    ...
    {
        return [
            // NOTE: 'code' is intentionally ABSENT — it is 100% auto-generated server-side on store().
